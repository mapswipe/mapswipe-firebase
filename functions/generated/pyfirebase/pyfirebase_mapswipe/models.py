...
class FbObjUnifiedOverlayTileServer(TypesyncModel):
    ...
    raster: typing.Union[TypesyncUndefined, FbObjRasterTileServerOverlay] = UNDEFINED
    vector: typing.Union[TypesyncUndefined, FbObjVectorTileServerOverlay] = UNDEFINED
...
class FbInformationPageBlock(TypesyncModel):
    ...
    textDescription: typing.Union[TypesyncUndefined, str] = UNDEFINED
    image: typing.Union[TypesyncUndefined, str] = UNDEFINED
...
class FbInformationPage(TypesyncModel):
    pageNumber: int
    title: str
    blocks: typing.List[FbInformationPageBlock]
...
class FbBaseTutorial(TypesyncModel):
    exampleImage1: typing.Union[TypesyncUndefined, str] = UNDEFINED
    exampleImage2: typing.Union[TypesyncUndefined, str] = UNDEFINED
    contributorCount: int
    informationPages: typing.List[FbInformationPage]
    lookFor: str
    name: str
    progress: int
    projectDetails: str
